...
async def lego(event):
    ...
    if event.sender_id != OWNER_ID and not quew:
        await event.reply(
            "𝗣𝗹𝗲𝗮𝘀𝗲 𝗴𝗶𝘃𝗲 𝗺𝗲 𝗦𝗼𝗺𝗲 𝗧𝗲𝘅𝘁 𝘁𝗼 𝗖𝗿𝗲𝗮𝘁𝗲 𝗟𝗼𝗴𝗼!\nExample `/logo <Sangram>`"
        )
        return
    pesan = await event.reply("𝗟𝗼𝗴𝗼 𝗶𝗻 𝗣𝗿𝗼𝗴𝗿𝗲𝘀𝘀. 𝗣𝗹𝗲𝗮𝘀𝗲 𝗪𝗮𝗶𝘁 𝗮 𝗦𝗲𝗰")
    try:
        ...
        await tbot.send_file(
            event.chat_id, file=fname, caption="**𝗟𝗼𝗴𝗼 𝗕𝘆 [𝗪𝗖𝗙](https://t.me/WorldChattingFriendsWCF)**"
        )
        await pesan.delete()
